...
Common:
  -g | --resource-group  - Name of the resource group to use. Defaults to demo-resources
  -n | --cluster-name - Name of the cluster to use. Defaults to demo-cluster
Up:
  ...
  -p | --public-ip-name - Name of the public IP to create. Defaults to demo-ext-ip
